...
client.on("message", (message) => {
    ...
    if (command === "powiedz") {
        if (!message.author.id == "380427062390947852") return message.channel.send("Nie masz permisji do użycia tej komendy!"); //poprawiłem trochę kod by było bardziej przejrzyście
